...
### Step 1: Clone the ansible-best-practices-windows Repository
...
1. In Visual Studio Code, right-click in the explorer pane and select New File.
2. Name the file `github_repo.py` file in the `labs/gh_module` directory of the cloned repository.
...
4. Copy files to the appropriate directory and execute.
